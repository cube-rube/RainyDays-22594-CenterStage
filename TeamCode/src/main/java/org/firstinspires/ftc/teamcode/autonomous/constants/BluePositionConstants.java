...
public class BluePositionConstants {
    ...
    public static Vector2d BACKDROP_RIGHT_VECTOR = new Vector2d(48.2, 29);
    ...
    public static Vector2d BACKDROP_LEFT_VECTOR = new Vector2d(48.2, 42);

    public static Vector2d DIFF_VECTOR = new Vector2d(0, 0.5);

    public static Vector2d RIGGING_UP_VECTOR = new Vector2d(20, 54);
    public static Vector2d RIGGING_DOWN_VECTOR = new Vector2d(-30, 54);
