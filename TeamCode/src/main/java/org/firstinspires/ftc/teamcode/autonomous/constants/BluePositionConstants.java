...
public class BluePositionConstants {
    ...
    public static double[] PURPLE_LEFT_NEAR = {22.65, 44, 270};
    ...
    public static Vector2d BACKDROP_CENTER_VECTOR = new Vector2d(48.9, 35.5);
    ...
    public static double[] RIGGING_UP_COORDS = {5, 59 - 0.425};
    public static Vector2d RIGGING_DOWN_VECTOR = new Vector2d(-30, 59);
    public static double[] RIGGING_DOWN_COORDS = {-45, 59 - 0.425};
