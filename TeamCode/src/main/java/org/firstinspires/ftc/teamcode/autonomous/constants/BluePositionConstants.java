...
public class BluePositionConstants {
    ...
    public static double[] BACKDROP_RIGHT_COORDS = {49.5, 31};
    public static Vector2d BACKDROP_CENTER_VECTOR = new Vector2d(48.9, 35);
    public static double[] BACKDROP_CENTER_COORDS = {49.5, 35};
    public static Vector2d BACKDROP_RIGHT_VECTOR = new Vector2d(49.6, 42);
    public static double[] BACKDROP_LEFT_COORDS = {49.5, 41.5};
    ...
    public static double[] DOOR_UP_COORDS = {24, 4};
    public static Vector2d DOOR_DOWN_VECTOR = new Vector2d(-40, 5);
    public static double[] DOOR_DOWN_COORDS = {-40, 4};
    ...
    public static double[] THIRD_PIXEL_STACK_COORDS = {-60.7, 11.5};
