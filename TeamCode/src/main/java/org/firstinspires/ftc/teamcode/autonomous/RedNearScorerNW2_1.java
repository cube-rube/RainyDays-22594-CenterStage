...
@Autonomous(name = "RedNearScorerNW2+2")
public class RedNearScorerNW2_1 extends LinearOpMode {
    ...
    private void move_left() {
        traj1 = drive.trajectorySequenceBuilder(NEAR_START_POSE)
                ...
                .waitSeconds(1.2)
                .lineToSplineHeading(new Pose2d(PURPLE_LEFT_VECTOR.plus(new Vector2d(1, 3.5)), PURPLE_LEFT_HEADING))
                .UNSTABLE_addTemporalMarkerOffset(0, () -> {
                    scorer.openLower();
                })
                ...
                .waitSeconds(0.2)
                .lineToSplineHeading(new Pose2d(BACKDROP_LEFT_VECTOR.plus(new Vector2d(1.5, 3.5)), Math.toRadians(0)))
                .waitSeconds(0.05)
                .UNSTABLE_addTemporalMarkerOffset(0, () -> {
                    scorer.openUpper();
                })
                ...
                .splineToConstantHeading(RIGGING_DOWN_VECTOR.plus(new Vector2d(-15, 0)), Math.toRadians(180))
        ...
        intake_traj1 = drive.trajectorySequenceBuilder(traj1.end())
                ...
                .lineToConstantHeading(PIXEL_STACK_VECTOR.plus(new Vector2d(-2.5, 0)))
                .build();
        ...
        traj2 = drive.trajectorySequenceBuilder(intake_traj1.end())
                ...
                .splineToConstantHeading(RIGGING_DOWN_VECTOR.plus(new Vector2d(-15, -0.2)), Math.toRadians(0))
    ...
    private void move_center() {
        ...
        intake_traj1 = drive.trajectorySequenceBuilder(traj1.end())
                ...
                .UNSTABLE_addTemporalMarkerOffset(0, () -> intake.take())
                .lineToConstantHeading(PIXEL_STACK_VECTOR.plus(new Vector2d(5, 1)))
                .lineToConstantHeading(PIXEL_STACK_VECTOR.plus(new Vector2d(-2.5, 1)))
                .build();
