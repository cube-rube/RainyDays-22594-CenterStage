...
public class PositionConstants {
    ...
    public static double[] BACKDROP_RIGHT_COORDS = {49.5, 29.5};
    public static Vector2d BACKDROP_CENTER_VECTOR = new Vector2d(48.9, 35);
    public static double[] BACKDROP_CENTER_COORDS = {49.5, 34.8};
    ...
    public static double[] THIRD_PIXEL_STACK_COORDS = {-60, 11.5};
