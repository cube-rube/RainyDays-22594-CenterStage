...
public class PositionConstants {
    ...
    public static double[] BACKDROP_RIGHT_COORDS = {49.5, 41.5};
    ...
    public static double[] DOOR_UP_COORDS = {24, 5};
    public static Vector2d DOOR_DOWN_VECTOR = new Vector2d(-40, 5);
    public static double[] DOOR_DOWN_COORDS = {-40, 5};
    ...
    public static double[] THIRD_PIXEL_STACK_COORDS = {-60.2, 11.5};
